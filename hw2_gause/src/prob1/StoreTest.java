...
public class StoreTest {
	...
	*/
	...
	public static void testAddEmp_Add_3() {
		...
		Store s = new Store();
		Employee e1 = createTestEmployee("Will", 23.0);
		Employee e2 = createTestEmployee("Bob", 29.0);
		Employee e3 = createTestEmployee("Steve", 26.0);
	...
	public static void testAddEmp_Add_20() {
		...
		Employee e2 = createTestEmployee("Bob", 29.0);
		Employee e3 = createTestEmployee("Steve", 26.0);
		Employee e4 = createTestEmployee("Alice", 24.0);
		Employee e5 = createTestEmployee("Eve", 27.0);
		Employee e6 = createTestEmployee("John", 28.0);
		Employee e7 = createTestEmployee("Mike", 25.0);
		Employee e8 = createTestEmployee("Sara", 30.0);
		Employee e9 = createTestEmployee("Lucy", 31.0);
		Employee e10 = createTestEmployee("Tom", 32.0);
		Employee e11 = createTestEmployee("Jerry", 33.0);
		Employee e12 = createTestEmployee("Anna", 34.0);
		Employee e13 = createTestEmployee("David", 35.0);
		Employee e14 = createTestEmployee("Sophia", 36.0);
		Employee e15 = createTestEmployee("Jack", 37.0);
		Employee e16 = createTestEmployee("Oliver", 38.0);
		Employee e17 = createTestEmployee("Emma", 39.0);
		Employee e18 = createTestEmployee("Liam", 40.0);
		Employee e19 = createTestEmployee("Mia", 41.0);
		Employee e20 = createTestEmployee("Noah", 42.0);
	...
	public static void testAddEmp_Add_21() {
		...
		Employee e19 = createTestEmployee("Mia", 41.0);
		Employee e20 = createTestEmployee("Noah", 42.0);
		Employee e21 = createTestEmployee("Danny", 21.0);
	...
	public static void testGetTotalHours_3_Employees() {
		...
		System.out.println("Total hours: expected=100.0, actual=" + + s.getTotalHours());
	}
	...
	public static void testGetTotalPay_3_Employees() {
		...
		System.out.println("Total hours: expected=1460.0, actual=" + + s.getTotalPay());
	}
